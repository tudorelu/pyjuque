...
def InitializeDatabaseTaBot(session, params={}):
    ...
    if params.__contains__('entry_settings'):
        ...
        if entry_settings.__contains__('trade_amount'):
            assert type(entry_settings['trade_amount']) in [int, float]
            trade_amount = entry_settings['trade_amount']
        ...
        if entry_settings.__contains__('reinvest_profits'):
            assert type(entry_settings['reinvest_profits']) in [bool]
            reinvest_profits = entry_settings['reinvest_profits']

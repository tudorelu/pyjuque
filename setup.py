...
setup(
	...
	install_requires=['yaspin==1.2.0', 'ccxt==1.40.23', 'pyyaml==5.3.1', 'numpy==1.19.4', 'pandas==1.1.4', 'plotly==4.12.0', 'python-dotenv==0.14.0', 'pyti==0.2.2','requests==2.23.0', 'SQLAlchemy==1.3.18', 'websocket==0.2.1', 'websocket-client==0.57.0'],
